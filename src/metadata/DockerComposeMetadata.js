 ...
 *
 */
class DockerComposeMetadata extends DefaultMetadata {
  /**
   * Default constructor.
   ...
   * @param {DockerComposeComponentDefinition} componentDefinition - Definition to get all parent
   * container types.
   ...
   * @param {DockerComposeComponentDefinition[]} componentDefinitions - Array of
...
export default DockerComposeMetadata;
