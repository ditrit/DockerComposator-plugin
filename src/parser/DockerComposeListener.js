...
class DockerComposeListener {
   ...
   * @param {MapNode} node - The node that contains the tree.
   * @param {string} type - The type of the component that will be created.
   * @returns {DockerComposeComponent} - The constructed Component
   */
  createComponentFromTree(node, type) {
    ...
    const component = new DockerComposeComponent({
      id,
      definition,
   ...
   * @param {DockerComposeComponent} parentComponent - The parent component (docker-compose)
   * whose reference will be added to the children.
   * @param {DockerComposeComponent[]} childComponents - The child components who will receive
...
export default DockerComposeListener;
